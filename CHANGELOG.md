...
- Bump Android SDK from v6.16.0 to v7.1.0 ([#81](https://github.com/mnordine/sentry-dart/pull/81))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#710)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.16.0...7.1.0)
